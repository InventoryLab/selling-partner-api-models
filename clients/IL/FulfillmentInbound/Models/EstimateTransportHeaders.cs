...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for estimateTransport operation.
    /// </summary>
    public partial class EstimateTransportHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EstimateTransportHeaders class.
        /// </summary>
        public EstimateTransportHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public EstimateTransportHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestid = default(string))
        {
