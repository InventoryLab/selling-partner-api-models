...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for getShipments operation.
    /// </summary>
    public partial class GetShipmentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetShipmentsHeaders class.
        /// </summary>
        public GetShipmentsHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetShipmentsHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
