...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for getBillOfLading operation.
    /// </summary>
    public partial class GetBillOfLadingHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetBillOfLadingHeaders class.
        /// </summary>
        public GetBillOfLadingHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetBillOfLadingHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
