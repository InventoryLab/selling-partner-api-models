...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for putTransportDetails operation.
    /// </summary>
    public partial class PutTransportDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PutTransportDetailsHeaders class.
        /// </summary>
        public PutTransportDetailsHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public PutTransportDetailsHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
