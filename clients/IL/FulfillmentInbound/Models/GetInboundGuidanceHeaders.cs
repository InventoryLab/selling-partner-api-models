...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for getInboundGuidance operation.
    /// </summary>
    public partial class GetInboundGuidanceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetInboundGuidanceHeaders class.
        /// </summary>
        public GetInboundGuidanceHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetInboundGuidanceHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
