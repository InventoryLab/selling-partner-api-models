...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for getPreorderInfo operation.
    /// </summary>
    public partial class GetPreorderInfoHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetPreorderInfoHeaders class.
        /// </summary>
        public GetPreorderInfoHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetPreorderInfoHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
