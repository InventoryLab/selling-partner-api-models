...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for createInboundShipmentPlan operation.
    /// </summary>
    public partial class CreateInboundShipmentPlanHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateInboundShipmentPlanHeaders
        /// class.
        /// </summary>
        public CreateInboundShipmentPlanHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public CreateInboundShipmentPlanHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
