...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for confirmTransport operation.
    /// </summary>
    public partial class ConfirmTransportHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ConfirmTransportHeaders class.
        /// </summary>
        public ConfirmTransportHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public ConfirmTransportHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestid = default(string))
        {
