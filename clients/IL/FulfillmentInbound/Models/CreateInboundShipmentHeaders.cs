...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for createInboundShipment operation.
    /// </summary>
    public partial class CreateInboundShipmentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateInboundShipmentHeaders
        /// class.
        /// </summary>
        public CreateInboundShipmentHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public CreateInboundShipmentHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
