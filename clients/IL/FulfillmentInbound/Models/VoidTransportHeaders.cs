...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for voidTransport operation.
    /// </summary>
    public partial class VoidTransportHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VoidTransportHeaders class.
        /// </summary>
        public VoidTransportHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public VoidTransportHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestid = default(string))
        {
