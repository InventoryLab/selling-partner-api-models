...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for getShipmentItemsByShipmentId operation.
    /// </summary>
    public partial class GetShipmentItemsByShipmentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetShipmentItemsByShipmentIdHeaders class.
        /// </summary>
        public GetShipmentItemsByShipmentIdHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetShipmentItemsByShipmentIdHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestid = default(string))
        {
