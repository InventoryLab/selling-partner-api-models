...
namespace IL.Library.Amazon.SPAPI.FulfillmentInbound.Models
{
    ...
    /// <summary>
    /// Defines headers for updateInboundShipment operation.
    /// </summary>
    public partial class UpdateInboundShipmentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateInboundShipmentHeaders
        /// class.
        /// </summary>
        public UpdateInboundShipmentHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public UpdateInboundShipmentHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestid = default(string))
        {
