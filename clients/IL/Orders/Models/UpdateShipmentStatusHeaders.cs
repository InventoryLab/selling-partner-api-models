...
namespace IL.Library.Amazon.SPAPI.Orders.Models
{
    ...
    /// <summary>
    /// Defines headers for updateShipmentStatus operation.
    /// </summary>
    public partial class UpdateShipmentStatusHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateShipmentStatusHeaders
        /// class.
        /// </summary>
        public UpdateShipmentStatusHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateShipmentStatusHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
