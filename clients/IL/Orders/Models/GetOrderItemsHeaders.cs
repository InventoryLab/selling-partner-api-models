...
namespace IL.Library.Amazon.SPAPI.Orders.Models
{
    ...
    /// <summary>
    /// Defines headers for getOrderItems operation.
    /// </summary>
    public partial class GetOrderItemsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetOrderItemsHeaders class.
        /// </summary>
        public GetOrderItemsHeaders()
        {
            CustomInit();
        }
        ...
        public GetOrderItemsHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
