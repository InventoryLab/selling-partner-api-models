...
namespace IL.Library.Amazon.SPAPI.Orders.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the OrderItemsBuyerInfoList class.
        /// </summary>
        ...
        /// page.</param>
        public OrderItemsBuyerInfoList(IList<OrderItemBuyerInfo> orderItems, string amazonOrderId, string nextToken = default(string))
        {
        ...
        public IList<OrderItemBuyerInfo> OrderItems { get; set; }
