...
namespace IL.Library.Amazon.SPAPI.Orders.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the GetOrderAddressResponse class.
        /// </summary>
        ...
        /// Initializes a new instance of the GetOrderAddressResponse class.
        /// </summary>
        /// <param name="payload">The payload for the getOrderAddress
        /// operations.</param>
        /// <param name="errors">One or more unexpected errors occurred during
        /// the getOrderAddress operation.</param>
        public GetOrderAddressResponse(OrderAddress payload = default(OrderAddress), IList<Error> errors = default(IList<Error>))
        {
            Payload = payload;
            Errors = errors;
            CustomInit();
        ...
        /// <summary>
        /// Gets or sets the payload for the getOrderAddress operations.
        /// </summary>
