...
namespace IL.Library.Amazon.SPAPI.Orders.Models
{
    ...
    /// <summary>
    /// Defines headers for getOrderItemsBuyerInfo operation.
    /// </summary>
    public partial class GetOrderItemsBuyerInfoHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetOrderItemsBuyerInfoHeaders
        /// class.
        /// </summary>
        public GetOrderItemsBuyerInfoHeaders()
        {
            CustomInit();
        }
        ...
        public GetOrderItemsBuyerInfoHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
