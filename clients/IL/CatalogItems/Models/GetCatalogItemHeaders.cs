...
namespace IL.Library.Amazon.SPAPI.CatalogItems.Models
{
    ...
    /// <summary>
    /// Defines headers for getCatalogItem operation.
    /// </summary>
    public partial class GetCatalogItemHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCatalogItemHeaders class.
        /// </summary>
        public GetCatalogItemHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetCatalogItemHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
