...
namespace IL.Library.Amazon.SPAPI.CatalogItems.Models
{
    ...
    /// <summary>
    /// Defines headers for searchCatalogItems operation.
    /// </summary>
    public partial class SearchCatalogItemsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SearchCatalogItemsHeaders class.
        /// </summary>
        public SearchCatalogItemsHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public SearchCatalogItemsHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
