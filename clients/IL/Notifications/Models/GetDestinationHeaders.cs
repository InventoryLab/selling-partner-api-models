...
namespace IL.Library.Amazon.SPAPI.Notifications.Models
{
    ...
    /// <summary>
    /// Defines headers for getDestination operation.
    /// </summary>
    public partial class GetDestinationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDestinationHeaders class.
        /// </summary>
        public GetDestinationHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetDestinationHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
