...
namespace IL.Library.Amazon.SPAPI.Notifications.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteDestination operation.
    /// </summary>
    public partial class DeleteDestinationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteDestinationHeaders class.
        /// </summary>
        public DeleteDestinationHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public DeleteDestinationHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
