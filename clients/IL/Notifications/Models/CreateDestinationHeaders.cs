...
namespace IL.Library.Amazon.SPAPI.Notifications.Models
{
    ...
    /// <summary>
    /// Defines headers for createDestination operation.
    /// </summary>
    public partial class CreateDestinationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateDestinationHeaders class.
        /// </summary>
        public CreateDestinationHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public CreateDestinationHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
