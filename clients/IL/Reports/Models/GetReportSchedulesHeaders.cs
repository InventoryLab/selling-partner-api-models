...
namespace IL.Library.Amazon.SPAPI.Reports.Models
{
    ...
    /// <summary>
    /// Defines headers for getReportSchedules operation.
    /// </summary>
    public partial class GetReportSchedulesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetReportSchedulesHeaders class.
        /// </summary>
        public GetReportSchedulesHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetReportSchedulesHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
