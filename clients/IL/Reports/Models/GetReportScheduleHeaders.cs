...
namespace IL.Library.Amazon.SPAPI.Reports.Models
{
    ...
    /// <summary>
    /// Defines headers for getReportSchedule operation.
    /// </summary>
    public partial class GetReportScheduleHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetReportScheduleHeaders class.
        /// </summary>
        public GetReportScheduleHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetReportScheduleHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
