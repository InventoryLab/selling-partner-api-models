...
namespace IL.Library.Amazon.SPAPI.Reports.Models
{
    ...
    /// <summary>
    /// Defines headers for getReportDocument operation.
    /// </summary>
    public partial class GetReportDocumentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetReportDocumentHeaders class.
        /// </summary>
        public GetReportDocumentHeaders()
        {
            CustomInit();
        }
        ...
        public GetReportDocumentHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
