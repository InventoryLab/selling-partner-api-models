...
namespace IL.Library.Amazon.SPAPI.ProductFees.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the FeeDetail class.
        /// </summary>
        public FeeDetail()
        {
            CustomInit();
        ...
        public FeeDetail(string feeType, MoneyType feeAmount, MoneyType finalFee, MoneyType feePromotion = default(MoneyType), MoneyType taxAmount = default(MoneyType), IList<IncludedFeeDetail> includedFeeDetailList = default(IList<IncludedFeeDetail>))
        {
            FeeType = feeType;
            FeeAmount = feeAmount;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "IncludedFeeDetailList")]
        public IList<IncludedFeeDetail> IncludedFeeDetailList { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element in IncludedFeeDetailList)
                {
                    if (element != null)
                    {
                        element.Validate();
