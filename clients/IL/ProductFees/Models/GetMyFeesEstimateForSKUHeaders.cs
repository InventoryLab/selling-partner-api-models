...
namespace IL.Library.Amazon.SPAPI.ProductFees.Models
{
    ...
    /// <summary>
    /// Defines headers for getMyFeesEstimateForSKU operation.
    /// </summary>
    public partial class GetMyFeesEstimateForSKUHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetMyFeesEstimateForSKUHeaders
        /// class.
        /// </summary>
        public GetMyFeesEstimateForSKUHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetMyFeesEstimateForSKUHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
