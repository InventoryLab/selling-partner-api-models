...
namespace IL.Library.Amazon.SPAPI.ProductFees.Models
{
    ...
    /// <summary>
    /// Defines headers for getMyFeesEstimateForASIN operation.
    /// </summary>
    public partial class GetMyFeesEstimateForASINHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetMyFeesEstimateForASINHeaders
        /// class.
        /// </summary>
        public GetMyFeesEstimateForASINHeaders()
        {
            CustomInit();
        }
        ...
        /// identifier.</param>
        public GetMyFeesEstimateForASINHeaders(string xAmznRateLimitLimit = default(string), string xAmznRequestId = default(string))
        {
