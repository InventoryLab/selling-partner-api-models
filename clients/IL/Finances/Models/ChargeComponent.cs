...
namespace IL.Library.Amazon.SPAPI.Finances.Models
{
    ...
    ///
    /// * CODItemTaxCharge - The tax collected by the seller on a
    /// CODItemCharge.
    ///
    ...
    ///
    /// * PointsFee - The value of Amazon Points deducted from the refund if
    /// the buyer does not have enough Amazon Points to cover the deduction.
    ///
    ...
    ///
    /// * ExportCharge - The export duty that is charged when an item is
    /// shipped to an international destination as part of the Amazon Global
    /// program.
    ///
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ChargeComponent class.
        /// </summary>
