...
namespace IL.Library.Amazon.SPAPI.FBAInboundEligibility.Models
{
    ...
    public partial class Error
    {
        ...
        /// <param name="details">Additional information that can help the
        /// caller understand or fix the issue.</param>
        public Error(string code, string message = default(string), string details = default(string))
        {
            Code = code;
            Message = message;
            Details = details;
        ...
        /// <summary>
        /// Gets or sets additional information that can help the caller
        /// understand or fix the issue.
        /// </summary>
