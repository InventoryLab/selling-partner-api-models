...
$templatFile = '..\models\listings-restrictions-api-model\listingsRestrictions_2021-08-01.json'
$outputFolder = '..\clients\IL\ListingsRestrictions'
$namespace = 'IL.Library.Amazon.SPAPI.ListingsRestrictions'
$clientname = 'ListingsRestrictionsClient'
